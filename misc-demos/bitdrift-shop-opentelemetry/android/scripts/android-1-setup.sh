...
#
# Mirrors ../../../../bitdrift-shop/android/scripts/android-1-setup.sh — same
# SDK levels and device profile (Medium Phone, 1080x2400), so AVD_NAME
# defaults to the same "Medium_Phone_Control" AVD shared across this repo's
# Android demos.
set -euo pipefail
