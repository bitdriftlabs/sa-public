...
| SC-4 | Memory Monitoring | ✅ Verified | Memory-pressure captured automatically on every crash (SDK 0.23.2+) and consumed directly inside the blocking-thread BDRL to tag contention crashes occurring under low memory. |
