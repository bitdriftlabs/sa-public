...
#
# Requires a running emulator (scripts/android-2-start-emulator.sh). Config comes from
...
if [[ -n "${BITDRIFT_SDK_KEY:-}" ]]; then
  ...
  printf '// GENERATED by scripts/android-3-start-app.sh — contains a live key. Do not commit.\nconst String generatedApiKey = %s;\n' "'${BITDRIFT_SDK_KEY}'" > "$GEN_KEY"
