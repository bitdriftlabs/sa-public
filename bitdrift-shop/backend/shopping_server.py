...
# ═══════════════════════════════════════════════════════════════════════════
# Structured JSON logging — injects OTel trace/span IDs when available
# ═══════════════════════════════════════════════════════════════════════════
...
# Use addHandler directly — logging.basicConfig() is a no-op when opentelemetry-instrument
# has already added its LoggingHandler to the root logger before the app is imported.
_root_logger = logging.getLogger()
_root_logger.setLevel(logging.INFO)
_root_logger.addHandler(_handler)
logger = logging.getLogger("shopdemo")

# Clear uvicorn's own handlers and let records propagate to root so the OTel LoggingHandler
# (added by auto-instrumentation to root) picks them up for OTLP export.
