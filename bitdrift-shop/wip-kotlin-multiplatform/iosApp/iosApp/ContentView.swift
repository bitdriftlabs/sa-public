...
struct ContentView: View {
    ...
    private func screenView(for route: ScreenRoute) -> some View {
        ...
        case "paymentAndroidPay":
            PaymentAndroidPayScreenView(checkoutSession: parts.count > 1 ? parts[1] : "")
        case "paymentFailed":
            PaymentFailedScreenView(paymentMethod: parts.count > 1 ? parts[1] : "unknown")
        case "confirmation":
